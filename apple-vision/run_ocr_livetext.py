"""Apple Vision LiveText (ImageAnalyzer) OCR test script (via ocrmac)."""
...
def main():
    ...
    results_dir = Path("results-livetext")
    results_dir.mkdir(exist_ok=True)

    print(f"Apple Vision LiveText OCR (ocrmac, ImageAnalyzer backend)")
    print("=" * 60)
